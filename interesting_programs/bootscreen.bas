  ...
  520 COLOUR 9 : IF C% = 2 THEN COLOUR 9 + 1
  530 PRINT TAB(10,1);"  ";CHR$(200);CHR$(201);"   ";
  540 PRINT TAB(10,2);"  ";CHR$(202);CHR$(203);"   ";
  550 PRINT TAB(10,3);" ";CHR$(204);CHR$(205);CHR$(206);CHR$(207);"  ";
  560 PRINT TAB(10,4);CHR$(208);CHR$(209);CHR$(210);CHR$(211);CHR$(212);CHR$(213);" ";
  570 PRINT TAB(10,5);CHR$(214);CHR$(215);CHR$(216);CHR$(209);CHR$(217);CHR$(218);" ";
  580 PRINT TAB(10,6);CHR$(219);CHR$(220);CHR$(221);CHR$(222);CHR$(223);CHR$(224);" ";
  590 PRINT TAB(10,7);CHR$(225);CHR$(226);CHR$(227);CHR$(228);CHR$(229);CHR$(230);" ";
  600 PRINT TAB(10,8);CHR$(231);CHR$(232);CHR$(233);CHR$(234);CHR$(235);CHR$(236);" ";
  ...
  650 COLOR 15 : PRINT TAB((W%-25)/2,1);"AGON LIGHT2 with eZ80 CPU"
  660 PROC_PRINT_CHAR_ARRAY((W%-31)/2,3,1)
  670 PROC_PRINT_CHAR_ARRAY((W%-31)/2,4,2)
  680 PRINT TAB((W%-23)/2,5);"SCREEN MODE: ";M%;" (";W%;"x";H%;")"
 ...
 1013 PRINT
 1014 COLOR 9 : REM COLOR FOR LEARN AGON IN GRAFFITI!
 1040 IF M% = 0 OR M% = 1 OR M% = 2 OR M% = 3 OR M% = 4 OR M% = 5 OR M% = 6 THEN 1041 ELSE 1049
 1041 REM PRINT LEARN AGON IN GRAFFITI!
 1042 PRINT TAB((W%-15)/2)"  Welcome to..."
 1043 PRINT"  .____                                   _____                       ._."
 1044 PRINT"  |    |    ____ _____ _______  ____     /  _  \    ____   ____   ____| |"
 1045 PRINT"  |    |  _/ __ \\__  \\_  __ \/    \   /  /_\  \  / ___\ /  _ \ /    \ |"
 1046 PRINT"  |    |__\  ___/ / __ \|  | \/   |  \ /    |    \/ /_/  >  <_> )   |  \|"
 1047 PRINT"  |_______ \___  >____  /__|  |___|  / \____|__  /\___  / \____/|___|  /_"
 1048 PRINT"          \/   \/     \/           \/          \//_____/             \/\/":COLOR 15: REM RESTORE COLOR TO WHITE
